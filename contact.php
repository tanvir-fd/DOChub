    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          <h1 class="text-capitalize mb-4 text-lg">Contact Us Anytime!</h1>
          <ul class="list-inline">
            <li class="list-inline-item"><a href="index.php" class="text-white">Home</a></li>
            <li class="list-inline-item"><span class="text-white">/</span></li>
            <li class="list-inline-item"><a href="contact.php" class="text-white-50">Contacts</a></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="container">
     	<div class="row">
			    ...
			    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
					...
					<div class="cbox-part text-center">
                        
                        <i class="fa cfa fa-mobile fa-5x" aria-hidden="true"></i>
						...
						<div class="ctext">
							<span class="cspan">
								<p>For any querry make a call to: <br><a href="tel:+880-1622-979454"><span>+880-1769-001002</span></a></p>
							</span>
						</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
					...
					<div class="cbox-part text-center">
                        ...
                        <i class="fa cfa fa-envelope fa-4x" aria-hidden="true"></i>
                        
						<div class="title">
							<h4 style="margin-top: 13px;">Email Us</h4>
						</div>
                        
						<div class="ctext">
							<span class="cspan">
								<p>Please leave a message to:<br><a href="mailto:support.dochub@gmail.com" ></i><span>support.dochub@gmail.com</span></a></p>
						</span>
						</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
					...
					<div class="cbox-part text-center">
                        ...
                        <i class="fa cfa fa-map-marker fa-5x" aria-hidden="true"></i>
						...
						<div class="ctext">
							<span class="cspan">
								<p><br><a href="https://goo.gl/maps/bRfxmU32ygsYsPg38"><span>1025/Avenue 10, Dhaka 1216</span></a></p>
							</span>
						</div>
		...
		<div class="row">
			...
			<div class="col-lg-3 ml-auto col-sm-6">
				<div class="widget">
					...
					<h6><a href="tel:+880-1622979454" >Mob: +880-1769-001002</a></h6>
					<a href="mailto:fuad.tanvir.360@gmail.com"><span class="text-color h4">support.dochub@gmail.com</span></a>
				</div>
			</div>
		</div>
