    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          <h1 class="text-capitalize mb-4 text-lg">Javascript Id (document name)</h1>
          <ul class="list-inline">
            <li class="list-inline-item"><a href="index.php" class="text-white">Home</a></li>
            <li class="list-inline-item"><span class="text-white">/</span></li>
            <li class="list-inline-item"><a href="#" class="text-white-50">Javascript ID (book name)</a></li>
          </ul>
        </div>
      </div>
    </div>
		...
		<div class="container-fliud">
			<div class="wrapper row">
				...
				<div class="preview-pic tab-content">
					<div class="tab-pane active" id="pic-1"><img src="https://images.pexels.com/photos/4855342/pexels-photo-4855342.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" /></div>
				</div>
				...
				<div class="details col-md-6">
					...
					<div class="rating">
						<span class="review-no">41 reviews (no of download)</span>
						<span class="review-no">Rating</span>
					</div>
