    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          <h1 class="text-capitalize mb-4 text-lg">Password Reset</h1>
          <ul class="list-inline">
            <li class="list-inline-item"><a href="index.php" class="text-white">Home</a></li>
            <li class="list-inline-item"><span class="text-white">/</span></li>
            <li class="list-inline-item"><a href="log.php" class="text-white">Log In</a></li>
            <li class="list-inline-item"><span class="text-white">/</span></li>
            <li class="list-inline-item"><a href="#" class="text-white-50">Forgot Password</a></li>
          </ul>
        </div>
      </div>
    </div>
  </div>
  <div class="container fgppadding-bottom-3x mb-2 mt-5">
	<div class="row justify-content-center">
		<div class="col-lg-8 col-md-10">
			<div class="fgpforgot fgpbg">
				<h2>Forgot your password?</h2>
				<p>Change your password in three easy steps. This will help you to secure your password!</p>
				<ol class="list-unstyled">
					<li><span class="text-white text-medium">1. </span>Enter your email address below.</li>
					<li><span class="text-white text-medium">2. </span>Our system will send you a temporary link</li>
					<li><span class="text-white text-medium">3. </span>Use the link to reset your password</li>
				</ol>
			</div>
			<form class="card mt-4" style="background: rgba(255, 250, 205, 0.452);">
				<div class="card-body">
					<div class="form-group"> <label for="email-for-pass" style="font-size: 20px;">Enter your email address:</label> <input class="form-control fgpform-control" type="text" id="email-for-pass" required=""><span class="form-text">Enter the email address you used during the registration on dochub.com. Then we'll email a link to this address.</span> </div>
				</div>
				<div style="padding: 0 0 20px 10px;"> <button class="btn fgpbtn btn-success" type="submit">Get New Password</button> <a href="log.php"><button class="btn fgpbtn btn-danger" type="button">Back to Login</button></a> </div>
			</form>
		</div>
	</div>
</div>
