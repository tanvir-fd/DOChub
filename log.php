      ...
      <div class="col-md-12">
        <div class="block text-center">
          ...
          <ul class="list-inline">
            ...
            <li class="list-inline-item"><a href="#" class="text-white-50">Log In</a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <div class="container scontainer">
	<div class="d-flex justify-content-center h-100">
		<div class="card scard">
			<div class="card-header scard-header">
				<h3>Sign In</h3>
			...
			<div class="card-body">
				<form>
					...
					<div class="form-group">
						<input type="submit" value="Login" class="btn-solid-border float-right login_btn">
					</div>
				</form>
			</div>
			<div class="card-footer">
				<div class="d-flex justify-content-center links text-color2">
					Don't have an account?<a href="sign.php" class="text-color3">Sign Up</a> <!--signup-->
				</div>
				<div class="d-flex justify-content-center">
					<a href="fgpass.php" class="text-color3">Forgot your password?</a> <!--forgot password-->
				</div>
			</div>
		</div>
	</div>
